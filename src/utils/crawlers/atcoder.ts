...
export const crawlAtCoder = async (username: string) => {
  try {
    ...
    const [problemsRes, problemDetail] = await Promise.all([
      axios.get('https://kenkoooo.com/atcoder/resources/problem-models.json', { timeout: 50000 }),
      axios.get('https://kenkoooo.com/atcoder/resources/problems.json', { timeout: 50000 })
    ]);
...
//       axios.get(`${METADATA_BASE}/problem-models.json`, { timeout: 50000 }),
//       axios.get(`${METADATA_BASE}/problems.json`, { timeout: 50000 })
//     ]);
